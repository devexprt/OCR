...
import { ProfileComponent } from './ui-elements/profile';
import { AusersComponent } from './pages/all-users';
import { AdduserComponent } from './pages/add-user';
import { AlldocumentsComponent } from './pages/all-scanned-documents';
import { ScandocumentComponent} from './pages/scan-your-document';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'pages/all-users', component: AusersComponent },
      { path: 'pages/add-user', component: AdduserComponent },
      ...
      { path: 'ui-elements/profile', component: ProfileComponent },
      { path: 'pages/all-scanned-documents', component: AlldocumentsComponent },
      { path: 'pages/scan-your-document', component: ScandocumentComponent },
