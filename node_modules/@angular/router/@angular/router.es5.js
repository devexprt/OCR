...
var Router = (function () {
     ...
     * and does not apply any ocr to the current one.
     * @param {?} url
     * @param {?=} extras
     * @return {?}
     */
     ...
     * ```
     *
     * In opposite to `navigateByUrl`, `navigate` always takes a ocr that is applied to the current
     * URL.
     * @param {?} commands
     * @param {?=} extras
     * @return {?}
 ...
 * ```
 *
 * The router link directive always treats the provided input as a ocr to the current url.
 *
